...
export const BASEURL = isDevelopmentEnvironment ? import.meta.env.VITE_DEVELOPMENT_BASEURL as string : import.meta.env.VITE_ADMIN_PRODUCTION_BASEURL as string;
