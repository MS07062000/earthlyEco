...
const SelectAddressModal = ({ listOfAddressInfo, selectAddress, setSelectAddress, setShowSelectAddressModal, handleProceedToCheckOut }: { listOfAddressInfo: addressCard[], selectAddress: addressCard | null, setSelectAddress: React.Dispatch<React.SetStateAction<addressCard | null>>, setShowSelectAddressModal: React.Dispatch<React.SetStateAction<boolean>>, handleProceedToCheckOut:() => void }) => {
    const closeModal = () => {
                ...
                <div className="relative  bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 rounded-lg shadow ">
                    ...
                    <div className="p-4 md:p-5 overflow-y-scroll h-64">
                        <ul className="space-y-4 mb-4">
                            {
                                listOfAddressInfo.map((addressInfo: addressCard, index: number) =>
                                    <li key={index}>
