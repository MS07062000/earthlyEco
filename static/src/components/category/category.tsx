...
import { memoizedCategorySelectors } from "../../store/selectors";
                            ...
                            <>
                                ...
                                <div className="mt-10 flex flex-row flex-wrap content-center justify-center gap-2 md:gap-4">
                                    {categoryState.categories.map((category: CategoryInfo, index: number) => {
                                        return (
                                            <figure id={category.name} onClick={() => { handleRedirect(category.name) }} key={index} className="w-[320px] flex flex-col justify-start items-center ">
