...
const sortBy = <T extends { price: number }>
    ...
    return (<div className="flex flex-col flex-nowrap items-end gap-1 fixed z-[40] right-4 top-[6.5rem] bg-[#fdd35b] w-full py-1">
        ...
        <div id="dropdown" className={`${isSortDropdownDisplay ? '' : 'hidden'} z-10 divide-y divide-gray-100 rounded-lg shadow min-w-min max-w-xs absolute top-[2.75rem] bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-md`}>
